    ...
    <div class="col-md-3">
    		<div class="card">
              ...
              <ul class="nav flex-column">
                <li><?= $this->Html->link('<i class="fas fa-list-ul"></i>&nbsp;Listado', ['action' => 'index'],['escape'=>false,'class'=>'nav-link']) ?></li>
                                    <li><?= $this->Html->link(__('<i class="fas fa-eye"></i>&nbsp;Editar'),['action' => 'edit', $proyectoCpanel->id],['escape'=>false,'class'=>'nav-link'])?></li>
                  <li><?= $this->Form->postLink(__('<i class="fas fa-times-circle"></i>&nbsp;Eliminar'),['action' => 'delete', $proyectoCpanel->id],['confirm' => __('Realmente desea eliminar el registro con Id # {0}?', $proyectoCpanel->id),'escape'=>false,'class'=>'nav-link'])?></li>
        ...
        <div class="col-md-9" >
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom"><?= __('Edit Proyecto Cpanel') ?></h2>
            </div>
          </header>
